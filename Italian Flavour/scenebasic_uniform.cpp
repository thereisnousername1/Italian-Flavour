...
void SceneBasic_Uniform::initScene()
{
    ...
    #pragma region (Light related) Light (ambient) intensity setting

    vec3 intense = vec3(0.1f);

    prog.setUniform("lights[0].La", intense);
    prog.setUniform("lights[1].La", intense);
    prog.setUniform("lights[2].La", intense);

    textureProg.setUniform("lights[0].La", intense);
    textureProg.setUniform("lights[1].La", intense);
    textureProg.setUniform("lights[2].La", intense);
